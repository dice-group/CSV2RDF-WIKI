...
class ResourceTest (unittest.TestCase):
  def setUp (self):
    self.testid = '1aa9c015-3c65-4385-8d34-60ca0a875728' # deviation free csv
    
    #'2409b9b4-3261-4543-9653-ffd28222b745' - zip file
  ...
  def test_09_get_csv_file_path(self):
    """ 9: Test get_csv_file_path method of Resource class """
    pass
  
  def test_10_download(self):
    """ 10: Download resource and check if downloaded file is not empty """
    pass
